...
\affil[45]{Department of Bioengineering, University of California, San Diego, La Jolla, Ca\ifornia 92093, US\authorcr}
...
\begin{figure}[b]
  \center
  \includegraphics[width=\textwidth]{resources/SBML-Level3-v10.pdf}
...
A wider impact of SBML as a \emph{de facto} standard has been the support of publishers and funding agencies. The majority of funding agencies have policies related to data-sharing, which some extend to research producing computational models, requiring these to be in a standard format. [need a reference or something]

...
\author[20]{Denis Thieffry}
\author[19]{Leandro Watanabe}
...
\author[47, 48]{Hiroaki Kitano}
\author[49]{Akira Funahashi}
...
\affil[25]{Center for Cell Analysis and Modeling, University of Connecticut School of Medicine, Farmington, CT 06032, US\authorcr}
...
F.B., A.D., M.H., T.M.H., S.M.K., B.O., and L.S., as well as SBML.org and its online resources, were supported by the National Institute of General Medical Sciences (NIGMS, US), grant \textnumero\ R0~GM070923 (PI: Hucka).
In addition, F.B. has been supported by the Bundesministerium fuer Bildung und Forschung (BMBF, DE), grant \textnumero\ de.NBI~ModSim1, 031L0104A (PI: Ursula Kummer).
A.F. was supported by the Grant-in-Aid for Young Scientists (B), grant \textnumero\ 21700328 from JSPS KAKENHI (JP) to Keio University.
J.F. was supported by National Institutes of Health (NIH, US) grant \textnumero\ P41-GM103712 to the National Center for Multiscale Modeling of Biological Systems (MMBioS).
H.H. was supported by the Biotechnology and Biological Sciences Research Council (BBSRC, UK) ``MultiMod'' project (grant \textnumero\ BB/N019482/1).
T.H. was supported by NIH (US) grant \textnumero\ 5R35GM119770-03 to the University of Nebraska--Lincoln.
S.H. was supported by NIGMS (US) grant \textnumero\ R01GM080219.
M.K. was supported by the Federal Ministry of Education and Research (BMBF, DE), research network Systems Medicine of the Liver (LiSyM), grant \textnumero\ 031L0054, Humboldt-University Berlin (PI: K\"{o}nig).
...
C.M. was supported by the National Science Foundation (NSF, USA) under grant \textnumero\ CCF-1748200.
I.M. was supported by NIH grant nos.\ P41-EB023912 and P41-GM103313.
K.M. was supported by the Department of Biotechnology, Government of India (grant \textnumero\ BT/PR4949/BRB/10/1048/2012).
M.M.-S. was supported by the Intramural Research Program of NIAID, NIH (US).
R.M.-S. was supported by the BBSRC (UK) ``MultiMod'' project (grant \textnumero\ BB/N019482/1).
B.P.'s was supported by NIH (US) grant \textnumero\ GM57089 to the University of California, San Diego.
H.M.S. was supported by NIGMS (US) grant \textnumero\ R01-GM123032 (PI: Sauro) and by the National Institute of Biomedical Imaging and Bioengineering (NIBIB, US) grant \textnumero\ P41-EB023912 (PI: Sauro).
...
N.S. was supported by BBSRC (UK) grant ``Centre for Synthetic Biology of Fine and Speciality Chemicals (SYNBIOCHEM)'', grant \textnumero\ BB/M017702/1 (PI: Nigel~S. Scrutton).

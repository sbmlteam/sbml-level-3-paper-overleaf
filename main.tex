...
\usepackage[noblocks]{authblk} % managing affiliations
\usepackage{wrapfig}
...
\author[12]{Frank T. Bergmann}
\author[13]{Andrew Finney}
\author[14]{Colin S. Gillespie}
\author[15]{Tomáš Helikar}
\author[16]{Stefan Hoops}
\author[17]{Rahuman S. Malik-Sheriff}
\author[18]{Stuart L. Moodie}
\author[19]{Ion I. Moraru}
\author[20]{Chris J. Myers}
\author[21]{Aurélien Naldi}
\author[22, 23, 24]{Brett G. Olivier}
\author[25]{Sven Sahle}
\author[26]{James C. Schaff}
\author[1, 27]{Lucian P. Smith}
\author[28]{Maciej J. Swat}
\author[29]{Denis Thieffry}
\author[20]{Leandro Watanabe}
\author[30, 31]{Darren J. Wilkinson}
\author[32]{Michael L. Blinov}
\author[33]{Kimberly Begley}
\author[34]{James R. Faeder}
\author[35]{Harold F. Gómez}
\author[36, 37]{Thomas M. Hamm}
\author[38]{Yuichiro Inagaki}
\author[39]{Wolfram Liebermeister}
\author[40]{Allyson L. Lister}
\author[41]{Daniel Lucio}
\author[42]{Eric Mjolsness}
\author[43]{Carole J Proctor}
\author[44, 45, 46]{Karthik Raman}
\author[47]{Nicolas Rodriguez}
\author[48]{Clifford A. Shaffer}
\author[49]{Bruce E. Shapiro}
\author[50]{Joerg Stelling}
\author[51]{Neil Swainston}
\author[52]{Naoki Tanimura}
\author[53]{John Wagner}
\author[6]{Martin Meier-Schellersheim}
\author[27]{Herbert M Sauro}
\author[54]{Bernhard Palsson}
\author[55]{Hamid Bolouri}
\author[57, 58]{Hiroaki Kitano}
\author[56]{Akira Funahashi}
\author[17]{Henning Hermjakob}
\author[1]{John C. Doyle}
\author[1]{Michael Hucka}


\affil[1]{Computing and Mathematical Sciences, California Institute of Technology, Pasadena, California 91125, US}

\affil[2]{European Bioinformatics Institute (EMBL-EBI), Hinxton, Cambridgeshire, UK}

\affil[3]{BioQuant/COS, Heidelberg University, Heidelberg 69120, DE}

\affil[4]{Medical Informatics, Institute for Community Health, University Medicine Greifswald, Greifswald, DE}

\affil[5]{Institute for Theoretical Biology, Humboldt-University Berlin, Berlin, 10115, DE}

\affil[6]{Laboratory of Immune System Biology, National Institute of Allergy and Infectious Diseases, National Institutes of Health, Bethesda, Maryland 20892, US}

\affil[7]{Computational Systems Biology of Infection and Antimicrobial-Resistant Pathogens, Institute for Biomedical Informatics (IBMI), University of Tübingen, 72076 Tübingen, DE}
\affil[8]{Department of Computer Science, University of Tübingen, 72076 Tübingen, DE}
\affil[9]{German Center for Infection Research (DZIF), partner site Tübingen, DE}

\affil[10]{Aix Marseille Univ, CNRS, Centrale Marseille, I2M, Marseille, 13288, FR}

\affil[11]{Instituto Gulbenkian de Ciência, Oeiras, P-2780-156, PT}

\affil[12]{BioQUANT/COS, Heidelberg University, Heidelberg, DE}

\affil[13]{ANSYS UK Ltd, UK}

\affil[14]{School of Mathematics, Statistics and Physics, Newcastle University, Newcastle upon Tyne, UK}

\affil[15]{Department of Biochemistry, University of Nebraska--Lincoln, Lincoln, Nebraska 68588, US}

\affil[16]{Biocomplexity Institute \& Initiative, University of Virginia, 995 Research Park Boulevard, Charlottesville, VA 22911, US}

\affil[17]{European Bioinformatics Institute (EMBL-EBI), European Molecular Biology Laboratory, Cambridge CB10 1SD, UK}

\affil[18]{Eight Pillars Ltd, 19 Redford Walk, Edinburgh EH13 0AG, UK}

\affil[19]{Center for Cell Analysis and Modeling, UConn Health, Farmington, CT 06030, US}

\affil[20]{Department of Electrical and Computer Engineering, University of Utah, Salt Lake City, UT 84112, US}

\affil[21]{Computational Systems Biology Team, Institut de Biologie de l’ENS (IBENS), Département de biologie, École normale supérieure, CNRS, INSERM, Université PSL, 75005 Paris, FR}

\affil[22]{"Systems Bioinformatics, AIMMS, Vrije Universiteit Amsterdam, Amsterdam 1081HZ, The Netherlands}
\affil[23]{BioQuant/COS, Heidelberg University, 69120 Heidelberg, DE}
\affil[24]{Computing and Mathematical Sciences, California Institute of Technology, Pasadena, California 91125, US}

\affil[25]{COS Heidelberg/BIOQUANT,  Heidelberg University, 69120 Heidelberg, DE}

\affil[26]{Applied BioMath, LLC, Concord, Massachusetts 01742, US}

\affil[27]{Department of Bioengineering, University of Washington, Seattle, WA, US}

\affil[28]{Simcyp (a Certara company), UK}

\affil[29]{Institut de Biologie de l'ENS (IBENS), Département de biologie, École normale supérieure, CNRS, INSERM, Université PSL, 75005 Paris, FR}

\affil[30]{School of Mathematics, Statistics and Physics, Newcastle University, Newcastle upon Tyne, NE1 7RU, UK}
\affil[31]{The Alan Turing Institute, British Library, London, NW1 2DB, UK}

\affil[32]{Center for Cell Analysis and Modeling, University of Connecticut School of Medicine, Farmington, CT 06032, US}

\affil[33]{Consultant, California Institute of Technology, Pasadena, California 91125, US}

\affil[34]{Department of Computational and Systems Biology, University of Pittsburgh, Pittsburgh, Pennsylvania 15260, US}

\affil[35]{Department of Biosystems Science and Engineering, ETH Zürich, Mattenstrasse 26, 4058, Basel, CH}

\affil[36]{Computational Systems Biology of Infection and Antimicrobial-Resistant Pathogens, Institute for Biomedical Informatics (IBMI), University of Tübingen, 72076 Tübingen, DE}
\affil[37]{Department of Computer Science, University of Tübingen, 72076 Tübingen, DE}

\affil[38]{Management \& IT Consulting Division, Mizuho Information \& Research Institute, Inc., 2-3, Kanda-Nishikicho, Chiyoda-ku, Tokyo, 101-8443, JP}

\affil[39]{Unité MaIAGE, UR1404, INRA, 78352 Jouy-en-Josas, FR}

\affil[40]{Oxford e-Research Centre (OeRC), Department of Engineering Science, University of Oxford, Oxford, UK}

\affil[41]{College of Sciences, NC State University, Raleigh, NC 27695, US}

\affil[42]{Department of Computer Science, University of California, Irvine, CA 92697, US}

\affil[43]{Institute of Cellular Medicine, Newcastle University, Newcastle upon Tyne, NE4 5PL, UK}

\affil[44]{Department of Biotechnology, Bhupat and Jyoti Mehta School of Biosciences, Indian Institute of Technology (IIT) Madras, Chennai - 600 036, IN}
\affil[45]{Initiative for Biological Systems Engineering (IBSE), IIT Madras, IN}
\affil[46]{Robert Bosch Centre for Data Science and Artificial Intelligence (RBC-DSAI), IIT Madras, IN}

\affil[47]{The Babraham Institute, Cambridge, CB22 3AT, UK}

\affil[48]{Department of Computer Science, Virginia Tech, Blacksburg, Virginia 24061, US}

\affil[49]{Department of Mathematics, California State University, Northridge, California 91325, US}

\affil[50]{Department of Biosystems Science and Engineering and SIB Swiss Institute of Bioinformatics, ETH Zurich, 4058 Basel, CH}

\affil[51]{Manchester Centre for Synthetic Biology of Fine and Speciality Chemicals (SYNBIOCHEM), Manchester Institute of Biotechnology, University of Manchester, Manchester M1 7DN, UK}

\affil[52]{Science Solutions Division, Mizuho Information & Research Institute, Inc., 2-3, Kanda-Nishikicho, Chiyoda-ku, Tokyo, 101-8443 JP}

\affil[53]{IBM Research Australia, Melbourne, AU}

\affil[54]{Department of Bioengineering, University of California, San Diego, La Jolla, California 92093, US}

\affil[55]{Allen Institute for Immunology, Seattle, Washington, US}

\affil[56]{Department of Biosciences and Informatics, Keio University, Yokohama, Kanagawa 223-8522, JP}

\affil[57]{The Systems Biology Institute, Tokyo, JP}
\affil[58]{Okinawa Institute of Science and Technology, Okinawa, JP}
...
\begin{enumerate}
	\item LibSBML~\citep{bornstein2008libsbml} (\tighturl{http://sbml.org/Software/libSBML}) is written in C++ and offers language interfaces for C, C++, C\#, Java, JavaScript, MATLAB, Octave, Perl, PHP, Python, R and Ruby
...
We sincerely thank all current and past SBML users, developers, contributors, advisors, administrators, and community members.  We give special thanks to the following people for countless contributions and support:
Jim Anderson,
Nadia Anwar,
Gordon Ball,
Duncan B\'{e}renguier,
...
F.B. has also been supported by the Bundesministerium fuer Bildung und Forschung (BMBF, DE), grant no.\ de.NBI~ModSim1, 031L0104A (PI: Ursula Kummer).

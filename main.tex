...
\author[17]{Stuart L. Moodie}
\author[18]{Ion I. Moraru}
\author[19]{Chris J. Myers}
\author[20]{Aurélien Naldi}
\author[21, 22, 1]{Brett G. Olivier}
\author[23]{Sven Sahle}
\author[24]{James C. Schaff}
\author[1, 25]{Lucian P. Smith}
\author[26]{Maciej J. Swat}
\author[21]{Denis Thieffry}
\author[20]{Leandro Watanabe}
\author[27, 28]{Darren J. Wilkinson}
\author[29]{Michael L. Blinov}
\author[30]{Kimberly Begley}
\author[31]{James R. Faeder}
\author[32]{Harold F. Gómez}
\author[7, 8]{Thomas M. Hamm}
\author[33]{Yuichiro Inagaki}
\author[34]{Wolfram Liebermeister}
\author[35]{Allyson L. Lister}
\author[36]{Daniel Lucio}
\author[37]{Eric Mjolsness}
\author[38]{Carole J Proctor}
\author[39, 40, 41]{Karthik Raman}
\author[42]{Nicolas Rodriguez}
\author[43]{Clifford A. Shaffer}
\author[44]{Bruce E. Shapiro}
\author[45]{Joerg Stelling}
\author[46]{Neil Swainston}
\author[47]{Naoki Tanimura}
\author[48]{John Wagner}
\author[6]{Martin Meier-Schellersheim}
\author[27]{Herbert M Sauro}
\author[49]{Bernhard Palsson}
\author[50]{Hamid Bolouri}
\author[51, 52]{Hiroaki Kitano}
\author[53]{Akira Funahashi}
\author[2]{Henning Hermjakob}
\author[1]{John C. Doyle}
\author[1]{Michael Hucka}
\author[54]{SBML Community members}
...
\affil[7]{Computational Systems Biology of Infection and Antimicrobial-Resistant Pathogens, Institute for Biomedical Informatics (IBMI), University of Tübingen, 72076 Tübingen, DE\authorcr}

\affil[8]{Department of Computer Science, University of Tübingen, 72076 Tübingen, DE\authorcr}

\affil[9]{German Center for Infection Research (DZIF), partner site Tübingen, DE\authorcr}

\affil[10]{Aix Marseille Univ, CNRS, Centrale Marseille, I2M, Marseille, 13288, FR\authorcr}

\affil[11]{Instituto Gulbenkian de Ciência, Oeiras, P-2780-156, PT\authorcr}

\affil[12]{BioQUANT/COS, Heidelberg University, Heidelberg, DE\authorcr}

\affil[13]{ANSYS UK Ltd, UK\authorcr}

\affil[14]{School of Mathematics, Statistics and Physics, Newcastle University, Newcastle upon Tyne, UK\authorcr}

\affil[15]{Department of Biochemistry, University of Nebraska--Lincoln, Lincoln, Nebraska 68588, US\authorcr}

\affil[16]{Biocomplexity Institute \& Initiative, University of Virginia, Charlottesville, Virginia 22911, US\authorcr}

\affil[17]{Eight Pillars Ltd, 19 Redford Walk, Edinburgh EH13 0AG, UK\authorcr}

\affil[18]{Center for Cell Analysis and Modeling, UConn Health, Farmington, Connecticut 06030, US\authorcr}

\affil[19]{Department of Electrical and Computer Engineering, University of Utah, Salt Lake City, UT 84112, US\authorcr}

\affil[20]{Institut de Biologie de l'ENS (IBENS), Département de biologie, École normale supérieure, CNRS, INSERM, Université PSL, 75005 Paris, FR\authorcr}

\affil[21]{"Systems Bioinformatics, AIMMS, Vrije Universiteit Amsterdam, Amsterdam 1081HZ, NL\authorcr}

\affil[22]{BioQuant/COS, Heidelberg University, 69120 Heidelberg, DE\authorcr}

\affil[23]{COS Heidelberg/BIOQUANT,  Heidelberg University, 69120 Heidelberg, DE\authorcr}

\affil[24]{Applied BioMath, LLC, Concord, Massachusetts 01742, US\authorcr}

\affil[25]{Department of Bioengineering, University of Washington, Seattle, Washington, US\authorcr}

\affil[26]{Simcyp (a Certara company), UK\authorcr}

\affil[27]{School of Mathematics, Statistics and Physics, Newcastle University, Newcastle upon Tyne, NE1 7RU, UK\authorcr}

\affil[28]{The Alan Turing Institute, British Library, London, NW1 2DB, UK\authorcr}

\affil[29]{Center for Cell Analysis and Modeling, University of Connecticut School of Medicine, Farmington, CT 06032, US\authorcr}

\affil[30]{Consultant, California Institute of Technology, Pasadena, California 91125, US\authorcr}

\affil[31]{\textls[-5]{Department of Computational and Systems Biology, University of Pittsburgh, Pittsburgh, Pennsylvania 15260, US}\authorcr}

\affil[32]{Department of Biosystems Science and Engineering, ETH Zürich, Mattenstrasse 26, 4058, Basel, CH\authorcr}

\affil[33]{Management \& IT Consulting Division, Mizuho Information \& Research Institute, Inc., 2-3, Kanda-Nishikicho, Chiyoda-ku, Tokyo, 101-8443, JP\authorcr}

\affil[34]{Unité MaIAGE, UR1404, INRA, 78352 Jouy-en-Josas, FR\authorcr}

\affil[35]{Oxford e-Research Centre (OeRC), Department of Engineering Science, University of Oxford, Oxford, UK\authorcr}

\affil[36]{College of Sciences, NC State University, Raleigh, North Carolina 27695, US\authorcr}

\affil[37]{Department of Computer Science, University of California, Irvine, California 92697, US\authorcr}

\affil[38]{Institute of Cellular Medicine, Newcastle University, Newcastle upon Tyne, NE4 5PL, UK\authorcr}

\affil[39]{Department of Biotechnology, Bhupat and Jyoti Mehta School of Biosciences, Indian Institute of Technology (IIT) Madras, Chennai - 600 036, IN\authorcr}

\affil[40]{Initiative for Biological Systems Engineering (IBSE), IIT Madras, IN\authorcr}

\affil[41]{Robert Bosch Centre for Data Science and Artificial Intelligence (RBC-DSAI), IIT Madras, IN\authorcr}

\affil[42]{The Babraham Institute, Cambridge, CB22 3AT, UK\authorcr}

\affil[43]{Department of Computer Science, Virginia Tech, Blacksburg, Virginia 24061, US\authorcr}

\affil[44]{Department of Mathematics, California State University, Northridge, California 91325, US\authorcr}

\affil[45]{Department of Biosystems Science and Engineering and SIB Swiss Institute of Bioinformatics, ETH Zürich, 4058 Basel, CH\authorcr}

\affil[46]{Manchester Centre for Synthetic Biology of Fine and Speciality Chemicals (SYNBIOCHEM), Manchester Institute of Biotechnology, University of Manchester, Manchester M1 7DN, UK\authorcr}

\affil[47]{Science Solutions Division, Mizuho Information \& Research Institute, Inc., 2-3, Kanda-Nishikicho, Chiyoda-ku, Tokyo, 101-8443 JP\authorcr}

\affil[48]{IBM Research Australia, Melbourne, AU\authorcr}

\affil[49]{Department of Bioengineering, University of California, San Diego, La Jolla, California 92093, US\authorcr}

\affil[50]{Allen Institute for Immunology, Seattle, Washington, US\authorcr}

\affil[51]{The Systems Biology Institute, Tokyo, JP\authorcr}

\affil[52]{Department of Biosciences and Informatics, Keio University, Yokohama, Kanagawa 223-8522, JP\authorcr}

\affil[53]{Okinawa Institute of Science and Technology, Okinawa, JP\authorcr}

\affil[54]{A complete list of members and affiliations appears in the Supplementary Note}
...
We sincerely thank all current and past SBML users, developers, contributors, supporters, advisors, administrators, and community members.  We give special thanks to the following people for countless contributions and support:
Jim Anderson,
Nadia Anwar,
Gordon Ball,
Duncan B\'{e}renguier,
